...
/***/ function(module, exports, __webpack_require__) {
	...
	var _initSvg = __webpack_require__(1);
	
	var _initSvg2 = _interopRequireDefault(_initSvg);
	...
	exports.default = {
	    run: function run(prop) {
	        ...
	        var replaceSVG = function replaceSVG(data) {
	            ...
	            var $svg = (0, _jquery2.default)(data).find('svg').clone();
	            ...
	            if (total === count) (0, _jquery2.default)(document).trigger('svgsLoaded', [count]);
	        };
	        ...
	        $svgs.each(function () {
	            ...
	            var imgURL = (0, _jquery2.default)(this).attr('src');
	
	            // if not cached, make new AJAX request
	            if (!cache[imgURL]) {
	                cache[imgURL] = _jquery2.default.get(imgURL).promise();
	            }
